...
@testset "RectDiagonal Multiplication" begin
    ...
    instances = Dict(
        ...
        :Diagonal          => Diagonal(rand(m)),
        :DiagonalFill      => Diagonal(Fill(val, m)),
        :DiagonalZeros     => Diagonal(Zeros(m)),
        :DiagonalOnes      => Diagonal(Ones(m)),
        :Zeros             => Zeros(m, n),
        :Ones              => Ones(m, n),
        :Fill              => Fill(val, m, n),
        :Mat               => rand(m, n),
