...
@testset "FillArray addition and subtraction" begin
    ...
    test_addition_and_subtraction(Any[A_fill, B_fill], Any[A_fill, B_fill], Fill)
    ...
    test_addition_and_subtraction(Any[A_fill, B_fill], Any[A_dense, B_dense], Array)
    ...
    test_addition_and_subtraction(Any[A_fill, B_fill], (A_ur, B_ur), AbstractRange)
...
@testset "Identities" begin
    ...
    @testset "`Zeros` are closed under addition and subtraction (both unary and binary)." begin
        ...
        test_addition_and_subtraction(Any[z1, z2], Any[z1, z2], Zeros)
    ...
    test_addition_and_subtraction(Any[z1, z2], Any[fill1, fill2], Fill)
